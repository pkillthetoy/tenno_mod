...
public class VoidIgnition_TENNO extends CustomCard {
  public static final String ID = "VoidIgnition_TENNO";
  private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
  public static final String NAME = cardStrings.NAME;
  public static final String DESCRIPTION = cardStrings.DESCRIPTION;
  public static final String DESCRIPTION_UPG = cardStrings.UPGRADE_DESCRIPTION;
  public static final String IMG_PATH = "img/cards/VoidIgnition.png";
  ...
  public void use(AbstractPlayer p, AbstractMonster m) {
    AbstractDungeon.actionManager.addToBottom(
        new ApplyPowerAction(
            p,
            p,
            new VoidIgnitionPower_TENNO(p, magicNumber), magicNumber));
  }

  public AbstractCard makeCopy() {
    return new VoidIgnition_TENNO();
  }
