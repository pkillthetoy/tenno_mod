...
public class VoidRadianceDamageAction extends com.megacrit.cardcrawl.actions.AbstractGameAction {
  private DamageInfo info;
  private static final float DURATION = Settings.ACTION_DUR_XFAST;
  private static final float POST_ATTACK_WAIT_DUR = Settings.ACTION_DUR_FASTER;
  private int numTimes;

  public VoidRadianceDamageAction(AbstractCreature target, DamageInfo info, int numTimes) {
    this.info = info;
    this.target = target;
