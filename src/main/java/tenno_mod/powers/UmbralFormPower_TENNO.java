...
public class UmbralFormPower_TENNO extends AbstractPower {
  public static final String POWER_ID = "UmbralFormPower_TENNO";
  ...
  public UmbralFormPower_TENNO(AbstractCreature owner, int amount) {
    this.ID = POWER_ID;
    this.name = NAME;
    this.owner = owner;
    this.amount = amount;
